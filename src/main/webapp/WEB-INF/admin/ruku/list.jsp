...
<html>
	...
	<body leftmargin="8" topmargin="8"'>
		...
		<!--  快速转换位置按钮  -->
		<!--  搜索表单  -->
		<form action="admin/ruku/list.jsp" method="post">
			...
			<div id="printTable">
				<table width="98%" border="0" cellpadding="2" cellspacing="1"
					...
					<%
						...
						if (queryName != null) {
							sql = "select * from ruku where danhao like '%" + queryName
									+ "%'";
						}
					...
					<tr align='center' bgcolor="#FFFFFF"
						...
						<td>
							<a href="admin/ruku/modRuku.jsp?id=<%=id%>">编辑</a> |
							<a href="DelRukuAction?id=<%=id%>">删除</a>
						</td>
					</tr>
					...
					<tr bgcolor="#FAFAF1">
						<td class="theader" colspan="10">
							<a href="admin/ruku/addRuku.jsp"><strong>添加入库</strong>
							</a>
						</td>
					</tr>
