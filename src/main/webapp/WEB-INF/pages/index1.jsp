...
<div class="culmn">
	...
	<nav class="navbar navbar-default navbar-fixed white no-background bootsnav">
		...
		<div class="container">    
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
					...
					<%-- <img src="${ctx}/staticfile/assets/images/logo.png" class="logo logo-display m-top-10" alt=""> --%>
	  ...
	  <div class="side">
			...
			<div class="widget">
				<h6 class="title">后台管理</h6>
				<ul class="link">
					<li><a href="javascript:window.open('login.action','_blank')">登录后台</a></li>
				...
				<div class="main_about">
					<div class="col-md-6">
						<div class="about_content">
							...
							<p><font size="5" >★ 头条新闻：
全天24小时最新物流和贸易新闻；让您快速了解重要的物流和贸易新闻；<br/> <br/>
★ 全媒体报道：
呈现海运、空运、陆运、贸易等十余种物流和贸易资讯信息，是您贴身的资讯专家；<br/> <br/>
★ 实时推送：
随时跟踪物流与贸易热点，让您与新鲜资讯保持零距离；<br/>
 </font></p>
					<!-- 下面按钮用于下载POI报表
					...
					<div class="col-md-6">
						<div class="about_accordion wow fadeIn">
							...
							<!-- 遍历新闻-->
								<h6><i class="fa fa-angle-right"></i> ${news.newsTitle}		<fmt:formatDate value="${news.newsDate}" pattern="yyyy-MM-dd HH:mm:ss" /></h6>
								<div>
									<div class="content">
										<p>${news.newsInfo}</p>
		...
		<div class="container">
			<div class="row">
				...
				<a href="Yunfei.action">
					...
					<a href="MyYundan.action?userName=${user.name }">
					<div class="col-md-4">
						<div class="about_bottom_item m-top-20">
							<div class="ab_head">
								<div class="ab_head_icon">
