			...
			<div class="row">
				<div class="main_about">
						...
						<div class="about_accordion wow fadeIn">
							<div id="faq_main_content" class="faq_main_content">
								<h6><i class="fa fa-angle-right"></i> <span class="time">
										 <font color="red">${myyudan.state }</font>
										 ${myyudan.danHao }&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;<fmt:formatDate value="${myyudan.date}" pattern="yyyy-MM-dd HH:mm:ss" /> </span>
								</h6>
								<div>
								<div class="content">
									
									<li>
									下单时间：<fmt:formatDate value="${myyudan.date}" pattern="yyyy-MM-dd HH:mm:ss" /></span>
									</li>
									
									<li>
										出发地联系方式：${myyudan.chuFadi }
									</li>
									<li>
										目的地联系方式：${myyudan.muDidi }
									</li>
									<li>
										收货人：${myyudan.faHuoRen }
									</li>
									<li>
										收货人：${myyudan.shouhuoren }
									</li>
					...
					<div class="about_btns m-top-40">
						<a href="topay.action?orderId=${myyudan.danHao }" class="btn btn-primary">去支付</a>
					</div>
				</div>			</div>
			<!--End off row-->
		</div><!--End off container -->
