			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1"
				...
				<c:forEach items="${user}" var="u" varStatus="status">
					...
					<tr align='center' bgcolor="#FFFFFF">
						...
						<td>${u.userName }</td>
						<td align="left">
							<div align="center">${u.userPw }</div>
						</td>
						<td align="left">
							<div align="center">${u.rname }</div>
						</td>
						<td align="left">
							<div align="center">${u.job }</div>
						</td>
						<td align="left">
							<div align="center">${u.tel }</div>
						</td>
						<td align="left">
							<div align="center">${u.age }</div>
						</td>

						<td><a href="toupdate.action?id=${u.id }">编辑</a> | <a
							href="todelete.action?id=${u.id }">删除</a></td>
					</tr>
